...
static RKADK_S32 RKADK_STREAM_RequestIDR(RKADK_U32 u32CamId,
  ...
  RKADK_STREAM_TYPE_E enType =
      RKADK_PARAM_VencChnMux(u32CamId, u32ChnId, RKADK_STREAM_TYPE_PREVIEW);
...
static bool RKADK_STREAM_IsUseRga(RKADK_U32 u32CamId,
...
RKADK_S32 RKADK_STREAM_VideoInit(RKADK_U32 u32CamID,
  ...
  bUseRga = RKADK_STREAM_IsUseRga(u32CamID, pstStreamCfg);
