...
if(LIBDRM_FOUND)
    if(LIBDRM_ROCKCHIP_FOUND)
        ...
        set(LIBDRM_INCLUDE_DIRS ${LIBDRM_INCLUDE_DIR}/..;${LIBDRM_INCLUDE_DIR};${LIBDRM_ROCKCHIP_INCLUDE_DIR})
        set(LIBDRM_CFLAGS "-DHAS_LIBDRM -DHAS_LIBDRM_ROCKCHIP")
    else()
        set(LIBDRM_LIBRARIES    ${LIBDRM_LIBRARY})
        set(LIBDRM_INCLUDE_DIRS ${LIBDRM_INCLUDE_DIR}/..;${LIBDRM_INCLUDE_DIR})
