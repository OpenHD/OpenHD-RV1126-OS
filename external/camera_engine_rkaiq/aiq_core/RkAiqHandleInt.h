...
public:
    ...
    XCamReturn GetZoomCalibStat(rk_aiq_af_zoomcalib_stat_t* stat);
...
public:
    ...
    XCamReturn setMfnrIQPara(rk_aiq_mfnr_IQPara_t *pPara);
    XCamReturn getMfnrIQPara(rk_aiq_mfnr_IQPara_t *pPara);
protected:
    virtual void init();
    virtual void deInit() {
        RkAiqAnrHandle::deInit();
...
private:
    ...
    rk_aiq_mfnr_IQPara_t mCurMfnrIQpara;
    rk_aiq_mfnr_IQPara_t mNewMfnrIQpara;
    bool UpdateIQpara = false;
    bool UpdateMfnrIQpara = false;
};
