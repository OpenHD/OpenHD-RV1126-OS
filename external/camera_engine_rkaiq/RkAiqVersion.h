...
#define RK_AIQ_VERSION_REAL_V "v1.0x77.2"
#define RK_AIQ_RELEASE_DATE "2023-03-25"
...
/*!
 * ==================== AIQ VERSION HISTORY (v1.0x67.3 ~ newest) ====================
 *
 * v1.0x77.2
 * - Support sperated TNR/NR/FEC devices instead of single ISPP device
 * - Fix a few issues in awb/3dlut/ccm/tmo
 * - Fix a few issues in hwi
 *
 * v1.0x77.1
 * - AE
 *
...
/*!
 * ==================== AIQ VERSION HISTORY (v0.0.9 ~ v1.0x67.1) ====================
 *
 * v0.0.9
