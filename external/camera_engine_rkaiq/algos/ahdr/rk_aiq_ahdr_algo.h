...
void AhdrGetAeProcRes( AhdrHandle_t pAhdrCtx, AecProcResult_t AecHdrProcResult);
...
RESULT AhdrInit(AhdrInstanceConfig_t* pInstConfig, CamCalibDbContext_t* pCalib) ;
