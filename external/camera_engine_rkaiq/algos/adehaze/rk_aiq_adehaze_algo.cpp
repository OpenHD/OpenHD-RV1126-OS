...
void AdehazeEnhanceApiOnProcess(AdehazeHandle_t* para, int iso, int mode)
{
    ...
    else if(para->AdehazeAtrr.mode == RK_AIQ_ENHANCE_MODE_MANUAL)
    {
        para->adhaz_config.dehaze_en[0] = FUNCTION_ENABLE;
        ...
        para->adhaz_config.dehaze_en[1] = FUNCTION_ENABLE;
        para->adhaz_config.dehaze_enhance[0] = FUNCTION_ENABLE;
        LOGD_ADEHAZE(" Dehaze fuction en:%d, Dehaze en:%d, Enhance en:%d,", FUNCTION_ENABLE, FUNCTION_DISABLE, FUNCTION_ENABLE );
        ...
        //enhance value
        para->adhaz_config.dehaze_enhance[1] += level_diff * 0.05;
        para->adhaz_config.dehaze_enhance[1] =
            LIMIT_VALUE(para->adhaz_config.dehaze_enhance[1], 15.0, 1.00);

        LOGD_ADEHAZE(" %s: Adehaze munual level:%f level_diff:%f\n", __func__, level, level_diff);
        LOGD_ADEHAZE(" %s: After manual api enhance value:%f\n", __func__, para->adhaz_config.dehaze_enhance[1]);
