...
public:
    ...
    virtual XCamReturn setNrStatsListener(nrStatsListener* nrStatsListener);
    ...
    virtual XCamReturn get_rkraw_frame_info(rkraw_frame_info_t *frame_info) {
        return  XCAM_RETURN_ERROR_FAILED;
    }
    ...
    virtual XCamReturn getEffectiveExpParams(uint32_t id, SmartPtr<RkAiqExpParamsProxy>& expParams, uint64_t &timestamp) {
        return  XCAM_RETURN_ERROR_FAILED;
    };
...
protected:
    ...
    nrStatsListener* mNrStatsLintener;
    int mWorkingMode;
