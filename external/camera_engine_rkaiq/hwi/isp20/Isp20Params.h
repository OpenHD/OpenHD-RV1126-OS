...
public:
    ...
    {   AntiTmoFlicker.preFrameNum = 0;
        ...
        AntiTmoFlicker.prev_lgmean = 40000;
        AntiTmoFlicker.prev_lgmean = 185;
    };
    virtual ~Isp20Params() {};
    ...
    virtual void convertAiqTnrResultsToTnrParams(struct rkispp_params_tnrcfg &tnr_cfg,
            SmartPtr<RkAiqTnrParamsProxy>& tnr_params);
    virtual XCamReturn convertAiqNrResultsToNrParams(struct rkispp_params_nrcfg &nr_cfg,
            SmartPtr<RkAiqNrParamsProxy>& nr_params);
    void convertAiqFecToIsp20Params(struct rkispp_params_feccfg& fec_cfg,
    ...
    s16 hdrtmoPredictK(float* luma, float* expo, s32 frameNum, PredictKPara_t *TmoPara);
    bool hdrtmoSceneStable(sint32_t frameId, TmoFlickerPara_t* pTmoFlicker, s32 frameNum);
    s16 CalcSetLgmean(sint32_t frameId, PredictPara_t* pPredict, TmoFlickerPara_t* pTmoFlicker);
    s16 CalcSetPalhpa(TmoProcRes_t* pTmoProc, PredictPara_t* pPredict, TmoFlickerPara_t* pTmoFlicker, unsigned short lgmean);
    s16 CalcSetLgrange0(TmoProcRes_t* pTmoProc, float lgmin, float lgmax);
    s16 CalcSetLgrange1(TmoProcRes_t* pTmoProc, float lgmin, float lgmax, unsigned short lgmean);
    s16 CalcSetLgavgmax(TmoProcRes_t* pTmoProc, unsigned short lgmean);
...
private:
    ...
    void convertAiqUvnrToIsp20Params(struct rkispp_params_nrcfg &nr_cfg,
                                     rk_aiq_isp_uvnr_t& uvnr);
    void convertAiqYnrToIsp20Params(struct rkispp_params_nrcfg &nr_cfg,
                                    rk_aiq_isp_ynr_t& ynr);
    void convertAiqSharpenToIsp20Params(struct rkispp_params_nrcfg &nr_cfg,
                                        rk_aiq_isp_sharpen_t& sharp,
