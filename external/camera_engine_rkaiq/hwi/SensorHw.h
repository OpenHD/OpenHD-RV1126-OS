...
private:
    ...
    int get_sony_brl(rk_aiq_exposure_sensor_descriptor* sns_des);
    XCamReturn _set_mirror_flip();
    XCamReturn get_readout_linecnt_perline (rk_aiq_exposure_sensor_descriptor* sns_des);
