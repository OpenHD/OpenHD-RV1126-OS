...
uint32_t calib_sensor_ahdr_Tmo_sub_tags[] = {
    ...
    CALIB_SENSOR_AHDR_TMO_AE_CONVERGED_THR_TAG_ID,
...
uint32_t calib_sensor_mfnr_sub_tags[] = {
    ...
    CALIB_SENSOR_MFNR_MOTION_DETECT_DS_SIZE_TAG_ID,
...
uint32_t calib_sensor_MFNR_motion_detection_sub_tags[] = {
    ...
    CALIB_SENSOR_MFNR_MOTION_DETECTION_DYNAMIC_EN_TAG_TD,
    CALIB_SENSOR_MFNR_MOTION_DETECTION_DYNAMICSW_TAG_ID,
    ...
    CALIB_SENSOR_MFNR_MOTION_DETECTION_GAIN_UPD_FLG_TAG_ID,
    CALIB_SENSOR_MFNR_MOTION_DETECTION_MD_SIGMA_SCALE_TAG_ID,
    CALIB_SENSOR_MFNR_MOTION_DETECTION_MED_EN_TAG_ID,
    CALIB_SENSOR_MFNR_MOTION_DETECTION_YUVNR_GAIN_SCALE3_TAG_ID,
    CALIB_SENSOR_MFNR_MOTION_DETECTION_YUVNR_GAIN_GLB_TAG_ID,
    CALIB_SENSOR_MFNR_MOTION_DETECTION_YUVNR_GAIN_TH_TAG_ID,
    CALIB_SENSOR_MFNR_MOTION_DETECTION_MFNR_GAIN_SCALE_TAG_ID,
    CALIB_SENSOR_MFNR_MOTION_DETECTION_MOTION_DN_STR_TAG_ID,
    CALIB_SENSOR_MFNR_MOTION_DETECTION_THRETH01_TAG_ID,
    CALIB_SENSOR_MFNR_MOTION_DETECTION_THRETH23_TAG_ID,
};
...
uint32_t calib_sensor_sensorinfo_sub_tags[] = {
    ...
    CALIB_SENSOR_SENSORINFO_CISHDRTIMEREG_MAXSTEP_TAG_ID,
...
uint32_t calib_sensor_lut3d_sub_tags[] = {
    ...
    CALIB_SENSOR_LUT3D_MODE_CELL_TAG_ID,
    CALIB_SENSOR_LUT3D_R_LUT_TAG_ID,
    CALIB_SENSOR_LUT3D_G_LUT_TAG_ID,
    CALIB_SENSOR_LUT3D_B_LUT_TAG_ID,
};

uint32_t calib_sensor_lut3d_mode_cell_sub_tags[] = {
    CALIB_SENSOR_LUT3D_MODE_NAME_TAG_ID,
    CALIB_SENSOR_LUT3D_R_LUT_TAG_ID,
    CALIB_SENSOR_LUT3D_G_LUT_TAG_ID,
    CALIB_SENSOR_LUT3D_B_LUT_TAG_ID,
};
...
uint32_t calib_sensor_eis_sub_tags[] = {
    ...
    CALIB_SENSOR_EIS_MODE_TAG_ID,
    CALIB_SENSOR_EIS_XML_PATH_TAG_ID,
    CALIB_SENSOR_EIS_CAMERA_MODEL_TAG_ID,
    CALIB_SENSOR_EIS_CAMERA_RATE_TAG_ID,
    CALIB_SENSOR_EIS_IMU_RATE_TAG_ID,
    CALIB_SENSOR_EIS_IMAGE_BUFFER_NUM_TAG_ID,
    CALIB_SENSOR_EIS_SRC_WIDTH_TAG_ID,
    CALIB_SENSOR_EIS_SRC_HEIGHT_TAG_ID,
    CALIB_SENSOR_EIS_DST_WIDTH_TAG_ID,
    CALIB_SENSOR_EIS_DST_HEIGHT_TAG_ID,
    CALIB_SENSOR_EIS_CLIP_RATIO_X_TAG_ID,
    CALIB_SENSOR_EIS_CLIP_RATIO_Y_TAG_ID,
    CALIB_SENSOR_EIS_FOCAL_LENGTH_TAG_ID,
    CALIB_SENSOR_EIS_LIGHT_CENTER_TAG_ID,
    CALIB_SENSOR_EIS_DISTORTION_COEFF_TAG_ID,
    CALIB_SENSOR_EIS_XI_TAG_ID,
    CALIB_SENSOR_EIS_GBIAS_X_TAG_ID,
    CALIB_SENSOR_EIS_GBIAS_Y_TAG_ID,
    CALIB_SENSOR_EIS_GBIAS_Z_TAG_ID,
    CALIB_SENSOR_EIS_TIME_OFFSET_TAG_ID,
    CALIB_SENSOR_EIS_SENSOR_AXIS_TYPE_TAG_ID,
    CALIB_SENSOR_EIS_SAVE_OBJPTS_PATH_TAG_ID,
};
...
calib_tag_info_t g_calib_tag_infos[CALIB_IQ_TAG_END] = {
    ...
    [CALIB_SENSOR_AHDR_TMO_AE_CONVERGED_THR_TAG_ID]         =
    {   "AeConvergedPdf", CALIB_TAG_TYPE_DOUBLE, {1, 1},
        check_tags_array_ignore, NULL
    },
    ...
    [CALIB_SENSOR_MFNR_MOTION_DETECT_DS_SIZE_TAG_ID]         =
    {   "motion_detect_ds_size", CALIB_TAG_TYPE_DOUBLE, {-1, -1},
        check_tags_array_ignore, NULL
    },
    [CALIB_SENSOR_MFNR_MODE_3TO1_TAG_ID]         =
    ...
    [CALIB_SENSOR_MFNR_MOTION_DETECTION_DYNAMIC_EN_TAG_TD]     =
    {
        "dynamicEnable", CALIB_TAG_TYPE_DOUBLE, {-1, -1},
        check_tags_array_ignore, NULL
    },
    [CALIB_SENSOR_MFNR_MOTION_DETECTION_DYNAMICSW_TAG_ID]       =
    {
        "dynamicSw",CALIB_TAG_TYPE_DOUBLE, {-1, -1},
        check_tags_array_ignore, NULL
    },
    ...
    [CALIB_SENSOR_MFNR_MOTION_DETECTION_GAIN_UPD_FLG_TAG_ID]         =
    {   "gain_upd_flag", CALIB_TAG_TYPE_DOUBLE, {-1, -1},
        check_tags_array_ignore, NULL
    },
    [CALIB_SENSOR_MFNR_MOTION_DETECTION_MD_SIGMA_SCALE_TAG_ID]         =
    {   "md_sigma_scale", CALIB_TAG_TYPE_DOUBLE, {-1, -1},
        check_tags_array_ignore, NULL
    },
    [CALIB_SENSOR_MFNR_MOTION_DETECTION_MED_EN_TAG_ID]         =
    {   "med_en", CALIB_TAG_TYPE_DOUBLE, {-1, -1},
        check_tags_array_ignore, NULL
    },
    [CALIB_SENSOR_MFNR_MOTION_DETECTION_YUVNR_GAIN_SCALE3_TAG_ID]         =
    {   "yuvnr_gain_scale3", CALIB_TAG_TYPE_DOUBLE, {-1, -1},
        check_tags_array_ignore, NULL
    },
    [CALIB_SENSOR_MFNR_MOTION_DETECTION_YUVNR_GAIN_GLB_TAG_ID]         =
    {   "yuvnr_gain_glb", CALIB_TAG_TYPE_DOUBLE, {-1, -1},
        check_tags_array_ignore, NULL
    },
    [CALIB_SENSOR_MFNR_MOTION_DETECTION_YUVNR_GAIN_TH_TAG_ID]         =
    {   "yuvnr_gain_th", CALIB_TAG_TYPE_DOUBLE, {-1, -1},
        check_tags_array_ignore, NULL
    },
    [CALIB_SENSOR_MFNR_MOTION_DETECTION_MFNR_GAIN_SCALE_TAG_ID]         =
    {   "mfnr_gain_scale", CALIB_TAG_TYPE_DOUBLE, {-1, -1},
        check_tags_array_ignore, NULL
    },
    [CALIB_SENSOR_MFNR_MOTION_DETECTION_MOTION_DN_STR_TAG_ID]         =
    {   "motion_dn_str", CALIB_TAG_TYPE_DOUBLE, {-1, -1},
        check_tags_array_ignore, NULL
    },
    [CALIB_SENSOR_MFNR_MOTION_DETECTION_THRETH01_TAG_ID]         =
    {   "thresh01", CALIB_TAG_TYPE_DOUBLE, {-1, -1},
        check_tags_array_ignore, NULL
    },
    [CALIB_SENSOR_MFNR_MOTION_DETECTION_THRETH23_TAG_ID]         =
    {   "thresh23", CALIB_TAG_TYPE_DOUBLE, {-1, -1},
        check_tags_array_ignore, NULL
    },
    ...
    [CALIB_SENSOR_SENSORINFO_CISHDRTIMEREG_MAXSTEP_TAG_ID]         =
    {   "CISHdrTimeRegMaxStep", CALIB_TAG_TYPE_DOUBLE, {-1, -1},
        check_tags_array_ignore, NULL
    },
    [CALIB_SENSOR_SENSORINFO_CISTIMEREG_UNEQUALEN_TAG_ID]         =
    ...
    [CALIB_SENSOR_LUT3D_MODE_CELL_TAG_ID]         =
    {   "Mode", CALIB_TAG_TYPE_CELL, {-1, -1},
        check_tags_array_info(calib_sensor_lut3d_mode_cell_sub_tags), NULL
    },
    [CALIB_SENSOR_LUT3D_MODE_NAME_TAG_ID]         =
    {   "Name", CALIB_TAG_TYPE_CHAR, {-1, -1},
        check_tags_array_ignore, NULL
    ...
    [CALIB_SENSOR_EIS_XML_PATH_TAG_ID]         =
    {   "xml_path", CALIB_TAG_TYPE_CHAR, {-1, -1},
        check_tags_array_ignore, NULL
    },
    [CALIB_SENSOR_EIS_CAMERA_MODEL_TAG_ID]         =
    {   "camera_model_type", CALIB_TAG_TYPE_INT, {-1, -1},
        check_tags_array_ignore, NULL
    },
    [CALIB_SENSOR_EIS_CAMERA_RATE_TAG_ID]         =
    {   "camera_rate", CALIB_TAG_TYPE_DOUBLE, {-1, -1},
        check_tags_array_ignore, NULL
    },
    [CALIB_SENSOR_EIS_IMU_RATE_TAG_ID]         =
    {   "imu_rate", CALIB_TAG_TYPE_DOUBLE, {-1, -1},
        check_tags_array_ignore, NULL
    },
    [CALIB_SENSOR_EIS_IMAGE_BUFFER_NUM_TAG_ID]         =
    {   "image_buffer_num", CALIB_TAG_TYPE_INT, {-1, -1},
        check_tags_array_ignore, NULL
    },
    [CALIB_SENSOR_EIS_SRC_WIDTH_TAG_ID]         =
    {   "src_width", CALIB_TAG_TYPE_INT, {-1, -1},
        check_tags_array_ignore, NULL
    },
    [CALIB_SENSOR_EIS_SRC_HEIGHT_TAG_ID]         =
    {   "src_height", CALIB_TAG_TYPE_INT, {-1, -1},
        check_tags_array_ignore, NULL
    },
    [CALIB_SENSOR_EIS_DST_WIDTH_TAG_ID]         =
    {   "dst_width", CALIB_TAG_TYPE_INT, {-1, -1},
        check_tags_array_ignore, NULL
    },
    [CALIB_SENSOR_EIS_DST_HEIGHT_TAG_ID]         =
    {   "dst_height", CALIB_TAG_TYPE_INT, {-1, -1},
        check_tags_array_ignore, NULL
    },
    [CALIB_SENSOR_EIS_CLIP_RATIO_X_TAG_ID]         =
    {   "clip_ratio_x", CALIB_TAG_TYPE_DOUBLE, {-1, -1},
        check_tags_array_ignore, NULL
    },
    [CALIB_SENSOR_EIS_CLIP_RATIO_Y_TAG_ID]         =
    {   "clip_ratio_y", CALIB_TAG_TYPE_DOUBLE, {-1, -1},
        check_tags_array_ignore, NULL
    },
    [CALIB_SENSOR_EIS_FOCAL_LENGTH_TAG_ID]         =
    {   "focal_length", CALIB_TAG_TYPE_DOUBLE, {-1, -1},
        check_tags_array_ignore, NULL
    },
    [CALIB_SENSOR_EIS_LIGHT_CENTER_TAG_ID]         =
    {   "light_center", CALIB_TAG_TYPE_DOUBLE, {-1, -1},
    ...
    [CALIB_SENSOR_EIS_XI_TAG_ID]         =
    {   "xi", CALIB_TAG_TYPE_DOUBLE, {-1, -1},
        check_tags_array_ignore, NULL
    },
    [CALIB_SENSOR_EIS_GBIAS_X_TAG_ID]         =
    {   "gbias_x", CALIB_TAG_TYPE_DOUBLE, {-1, -1},
        check_tags_array_ignore, NULL
    },
    [CALIB_SENSOR_EIS_GBIAS_Y_TAG_ID]         =
    {   "gbias_y", CALIB_TAG_TYPE_DOUBLE, {-1, -1},
        check_tags_array_ignore, NULL
    },
    [CALIB_SENSOR_EIS_GBIAS_Z_TAG_ID]         =
    {   "gbias_z", CALIB_TAG_TYPE_DOUBLE, {-1, -1},
        check_tags_array_ignore, NULL
    },
    [CALIB_SENSOR_EIS_TIME_OFFSET_TAG_ID]         =
    {   "time_offset", CALIB_TAG_TYPE_DOUBLE, {-1, -1},
        check_tags_array_ignore, NULL
    },
    [CALIB_SENSOR_EIS_SENSOR_AXIS_TYPE_TAG_ID]         =
    {   "sensor_axes_type", CALIB_TAG_TYPE_INT, {-1, -1},
        check_tags_array_ignore, NULL
    },
    [CALIB_SENSOR_EIS_SAVE_OBJPTS_PATH_TAG_ID]         =
    {   "save_objpts_path", CALIB_TAG_TYPE_CHAR, {-1, -1},
        check_tags_array_ignore, NULL
    },
