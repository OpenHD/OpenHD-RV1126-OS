...
# Set the version to the latest commit or specific tag/branch
OPENHD_VERSION = 2.6-evo

# Subdirectory inside the Git repo, if needed
OPENHD_SUBDIR = OpenHD

# Install to both the staging directory and target
...
# Show the staging directory
$(info The Staging Directory is: $(STAGING_DIR))

# Put the list of files into a variable, then print them.
OPENHD_STAGING_FILES := $(shell find $(STAGING_DIR) -type f -print)

$(info Listing all files in the staging directory:)
$(info $(OPENHD_STAGING_FILES))
